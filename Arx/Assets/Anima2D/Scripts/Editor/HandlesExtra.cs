	...
	public class HandlesExtra
	{
		...
		public class Styles
		{
			...
			public Styles()
			{
				...
				dotCyan.normal.background = EditorGUIUtility.LoadRequired("Assets/Example/Editor Default Resources/Anima2D/dotCyan.png") as Texture2D;

				dotYellow.fixedWidth = 8f;
				dotYellow.fixedHeight = 8f;
				dotYellow.normal.background = EditorGUIUtility.LoadRequired("Assets/Example/Editor Default Resources/Anima2D/dotYellow.png") as Texture2D;

				dotRed.fixedWidth = 8f;
				dotRed.fixedHeight = 8f;
				dotRed.normal.background = EditorGUIUtility.LoadRequired("Assets/Example/Editor Default Resources/Anima2D/dotRed.png") as Texture2D;

				dotBlackBig.fixedWidth = 23.5f;
				dotBlackBig.fixedHeight = 23.5f;
				dotBlackBig.normal.background = EditorGUIUtility.LoadRequired("Assets/Example/Editor Default Resources/Anima2D/dotBlackBig.png") as Texture2D;

				dotYellowBig.fixedWidth = 23.5f;
				dotYellowBig.fixedHeight = 23.5f;
				dotYellowBig.normal.background = EditorGUIUtility.LoadRequired("Assets/Example/Editor Default Resources/Anima2D/dotYellowBig.png") as Texture2D;
			}
		}
