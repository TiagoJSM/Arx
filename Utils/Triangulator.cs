...
namespace Utils
{
    ...
    {
        public static int[] TriangulatePolygon(Vector2[] vs)
        {
            var aux = new TriangulatorAux(vs);
            return aux.Triangulate();
        }

        public class TriangulatorAux
        {
            private List<Vector2> m_points = new List<Vector2>();

            public TriangulatorAux(Vector2[] points)
            {
