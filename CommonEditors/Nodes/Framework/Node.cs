...
//		[NonSerialized]
		...
		/// </summary>
		public virtual void OnAddInputConnection (NodeInput input) {}

		/// <summary>
		/// Callback when the NodeOutput was assigned a new connection (the last in the list)
		/// </summary>
		public virtual void OnAddOutputConnection (NodeOutput output) {}

		/// <summary>
		/// Callback when the Transition was created
		/// </summary>
		protected virtual void OnAddTransition (Transition transition) {}
		...
		/// </summary>
		public virtual void OnEnter (Transition originTransition) {}

		/// <summary>
		/// Callback when the this Node is transitioning to another Node through the passed Transition
		/// </summary>
		public virtual void OnLeave (Transition transition) {}
		...
		/// </summary>
		protected bool hasUnassignedInputs () 
		{
			for (int inCnt = 0; inCnt < Inputs.Count; inCnt++)
